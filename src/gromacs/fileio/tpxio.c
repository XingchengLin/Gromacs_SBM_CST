...
#endif
#ifdef SBM_RUMB
      , tpxv_SBM_RUMB = 102 /* tpxv_SBM + 1 , if defined */
#endif // SBM_RUMB
};
...
#elif SBM 
static const int tpx_version = tpxv_SBM;
#else
...
static const t_ftupd ftupd[] = {
   ...
   { tpxv_SBM, F_TWOANGLE       },
   { tpxv_SBM, F_TWODIHS       },
   { tpxv_SBM, F_BAREGAUSS   },
   { tpxv_SBM, F_GAUSS       },
   { tpxv_SBM, F_TWOGAUSS        },
#endif // SBM
#ifdef SBM_RUMB
   { tpxv_SBM_RUMB, F_PUMBRELLA       },
   { tpxv_SBM_RUMB, F_TUMBRELLA       },
#endif // SBM_RUMB
   { 65, F_CMAP              },
   { 60, F_GB12              },
   { 61, F_GB13              },
      ...
      gmx_bool bRead, int file_version)
{
   ...
   switch (ftype)
   {
	 ...
	 break;
      case F_TUMBRELLA:
         gmx_fio_do_real(fio,iparams->tumbrella.amp);
         gmx_fio_do_real(fio,iparams->tumbrella.mu);
         gmx_fio_do_real(fio,iparams->tumbrella.kappa);
         gmx_fio_do_real(fio,iparams->tumbrella.cut);
         break;
#endif
#ifdef SBM
      case F_TWOANGLE:
	 gmx_fio_do_real(fio,iparams->twoangle.r1);
	 gmx_fio_do_real(fio,iparams->twoangle.k1);
	 gmx_fio_do_real(fio,iparams->twoangle.r2);
	 gmx_fio_do_real(fio,iparams->twoangle.k2);
	 gmx_fio_do_real(fio,iparams->twoangle.bar);
	 gmx_fio_do_real(fio,iparams->twoangle.mid);
	 gmx_fio_do_real(fio,iparams->twoangle.a);
	 gmx_fio_do_real(fio,iparams->twoangle.b);
	 break;
      case F_TWODIHS:
	 gmx_fio_do_real(fio,iparams->twodihs.amp);
	 gmx_fio_do_real(fio,iparams->twodihs.mu1);
	 gmx_fio_do_real(fio,iparams->twodihs.mu2);
	 break;
#endif // SBM
