...
const t_interaction_function interaction_function[F_NRE] =
{
...
#ifdef SBM
   def_bonded  ("TWOANGLE", "2 Angles",        3, 5, 0,  eNR_TWOANGLE, twoangle    ),    
   def_bonded  ("TWODIHS",  "2 Dihedrals",     4, 3, 0,  eNR_TWODIHS, twodihs      ),
   ...
   def_bondedz ("TUMBRELLA","tUmbrella",       2, 4, 0,  eNR_TUMBRELLA, pair_umbrella_tanh),
#endif // SBM_RUMB
